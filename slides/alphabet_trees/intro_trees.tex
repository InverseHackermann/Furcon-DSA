...
\frame{
 ...
 \begin{itemize}
    ...
    \item \textbf{B}C\textbf{M}UXY : Other Binary Trees

    \medskip

    \item I\textbf{K}QV : Spatial Data Structures

    \medskip 

    \item \textbf{E}FGJ\textbf{L}P : Niche data structures

    \medskip 

    \item \textbf{DHN}OW :  Non-data structures
  \end{itemize}
}
