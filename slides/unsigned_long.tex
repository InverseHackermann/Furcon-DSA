\section{How I Found the Fandom}
...
\item<5-> Pun was too good to do nothing with, so I made a fursona
\end{itemize}
...
\scalebox{-1}[1]{\includegraphics[width=0.43\textwidth]{slides/unsigned_long/refsheet_back.png}}
\end{figure}
